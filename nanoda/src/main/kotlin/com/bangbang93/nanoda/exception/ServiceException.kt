...
open class ServiceException(
  ...
  class UnknownServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_UNKNOWN", 500, data, cause)
  ...
  class NeedLoginServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_NEED_LOGIN", 401, data, cause)
  ...
  class NotFoundServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_NOT_FOUND", 404, data, cause)
  ...
  class PermissionDeniedServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_PERMISSION_DENIED", 403, data, cause)
  ...
  class MissingArgumentServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_MISSING_ARGUMENT", 400, data, cause)
  ...
  class InvalidArgumentServiceException(
      ...
      cause: Throwable? = null,
      data: Map<Any, Any>? = null,
  ) : ServiceException(message, "COMMON_INVALID_ARGUMENT", 400, data, cause)
}
